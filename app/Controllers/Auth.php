    ...
    public function update_user()
    {
        ...
        if ($this->request->getMethod() == 'post') {
            ...
            if ($password !== $cpassword) {
                ...
                if ($update) {
                    $session->setFlashdata('success', "Su cuenta ha sido actualizada con éxito.");
                    ...
                    $session->setFlashdata('error', "Su cuenta no se ha podido actualizar.");
                }
            }
        }
