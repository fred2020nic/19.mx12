...
<div class="card rounded-0">
    ...
    <div class="card-body">
        <div class="container-fluid">
            <form action="<?= base_url("Main/save_transaction") ?>" id="transaction-form" method="POST" onkeydown="return event.key != 'Enter';">
                    ...
                    <table class="table table-bordered">
                        ...
                        <thead>
                            <tr class="bg-gradient bg-primary text-light">
                                ...
                                <th class="p-1 text-center">Precio Unitario</th>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tfoot>
                            <tr class="bg-warning bg-gradient bg-opacity-25 text-dark">
                                <th class="p-1 text-center" colspan="4">Monto Total</th>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <label for="customer" class="control-label">Nombre del Cliente</label>
                        <input type="text" class="form-control rounded-0" id="customer" name="customer" required="required">
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="mb-3">
                            <label for="tendered" class="control-label">Monto Pagado</label>
                            <input type="number" step="any" class="form-control rounded-0" id="tendered" name="tendered" required="required">
                        </div>
                        <div class="h4 mb-0 fw-bolder text-end"><span class="text-muted">Cambio:</span> <span class="ms-2" id="change">0.00</span></div>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="card-footer text-center">
        <button class="btn btn-primary rounded-0" id="save_transaction" type="button"><i class="fa fa-save"></i> Guardar Transacción</button>
    </div>
</div>
