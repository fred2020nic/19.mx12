...
<div class="col-lg-3 col-md-4 col-sm-10 col-xs-12">
    <div class="card rounded-0">
        <div class="card-header">
            <div class="card-title h4 mb-0 text-center">Acceso al Sistema</div>
        </div>
        <div class="card-body">
                ...
                <form action="<?= base_url('login') ?>" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group rounded-0">
                            <input type="email" class="form-control rounded-0" id="email" name="email" autofocus placeholder="Correo Electrónico" value="<?= !empty($data->getPost('email')) ? $data->getPost('email') : '' ?>" required="required">
                    ...
                    <div class="d-grid gap-1">
                        <button class="btn rounded-0 btn-primary bg-gradient">Acceder</button>
                    </div>
                    <div class="mb-3">
